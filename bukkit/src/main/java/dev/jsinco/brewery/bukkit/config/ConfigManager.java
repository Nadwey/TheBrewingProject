package dev.jsinco.brewery.bukkit.config;

import dev.jsinco.brewery.bukkit.TheBrewingProject;
import dev.jsinco.brewery.bukkit.config.sections.Config;
import dev.jsinco.brewery.bukkit.config.sections.CustomIngredientsConfig;
import dev.jsinco.brewery.bukkit.config.sections.RecipesConfig;
import dev.jsinco.brewery.bukkit.config.serdes.PercentageTransformer;
